...
int libraryMenuUtils::addBookUI(){
    ...
    cout << "." << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << "2" << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);    
    cout << "1" << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << "." << flush;mcsecsleep(num);
    cout << reset;
...
int libraryMenuUtils::addStudent(){
    cout << inverse + "Type your input with this form \""+italy+red+"<Student's Id>"+reset+inverse+"|"+italy+ red+"<Name>"+reset+inverse+"|"+italy+ red+"<Class>"+reset+inverse+"\" to add" + reset;
    cout << inverse + " or type "+red+"back"+reset+inverse+" to return: "+reset;
    ...
    cout << endl;
    this->studentControl->addStudent(param[0],param[1],param[2]);
...
int libraryMenuUtils::removeStudent(){
    cout << inverse + "Type the "+red+"student's ID"+reset+inverse+" you wish removing";
    cout << inverse + " or type "+red+"back"+reset+inverse+" to return: "+reset;
    ...
    cout << endl;
    this->studentControl->removeStudent(str);
