...
int menuHandler::printMenu(){
    ...
    const int terminalWidth = 54; //don't change
    ...
    << string(terminalWidth- (terminalWidth/27)- (terminalWidth/27) -2 - line0.length() +3 -11, ' ') << "|" << string(terminalWidth/27, ' ') << "|" << '\n';
    
    cout << string(3, ' '); cout << "|" << string(terminalWidth/27, ' ') << "|           " << line1 + reset
    << string(terminalWidth- (terminalWidth/27)- (terminalWidth/27) -2 - line1.length() +3 -11, ' ') << "|" << string(terminalWidth/27, ' ') << "|" << '\n';
    
    cout << string(3, ' '); cout << "|" << string(terminalWidth/27, ' ') << "|           " << line2 + reset
    << string(terminalWidth- (terminalWidth/27)- (terminalWidth/27) -2 - line2.length() +3 -11, ' ') << "|" << string(terminalWidth/27, ' ') << "|" << '\n';
    
    cout << string(3, ' '); cout << "|" << string(terminalWidth/27, ' ') << "|           " << line3 + reset
    << string(terminalWidth- (terminalWidth/27)- (terminalWidth/27) -2 - line3.length() +3 -11, ' ') << "|" << string(terminalWidth/27, ' ') << "|" << '\n';
...
int menuHandler::printStudentData(){
    ...
    << left << setw(8+Class_length) <<inverse+ "Class" +reset << left << setw(8+Inuse_length) <<inverse+ "In use" +reset << left << setw(8+Info_length) <<inverse+ "Books' Info" +inverse_off+reset << "\n";
    for (int i = 0; i < dataMain->studentData.size(); i++)
    {
...
int menuHandler::printTheLibrary(){
    ...
    << left << setw(8+Code_length) <<inverse+ "Code" +reset << left << setw(8+Inuse_Amount_length) <<inverse+ "Amount" +reset << left << setw(8+Users_length) <<inverse+ "Users" +inverse_off+reset << "\n";
    for (int i = 0; i < dataMain->data.size(); i++)
    {
...
int menuHandler::processingAnimation(){
    ...
    int param = 60000;
    int param2 = 400000;
    cout << "P"<< flush; mcsecsleep(param);cout << "r"<< flush; mcsecsleep(param);cout << "o"<< flush; mcsecsleep(param);cout << "g"<< flush; mcsecsleep(param);cout << "r"<< flush; mcsecsleep(param);cout << "a"<< flush; mcsecsleep(param);cout << "m"<< flush; mcsecsleep(param);cout << " "<< flush; mcsecsleep(param);
    cout << "i"<< flush; mcsecsleep(param);cout << "s"<< flush; mcsecsleep(param);cout << " "<< flush; mcsecsleep(param);
    cout << "r"<< flush; mcsecsleep(param);cout << "u"<< flush; mcsecsleep(param);cout << "n"<< flush; mcsecsleep(param);cout << "n"<< flush; mcsecsleep(param);cout << "i"<< flush; mcsecsleep(param);cout << "n"<< flush; mcsecsleep(param);cout << "g"<< flush; mcsecsleep(param);
    cout << ", "<< flush; mcsecsleep(param);cout << red+"p"<< flush; mcsecsleep(param);cout << "l"<< flush; mcsecsleep(param);cout << "e"<< flush; mcsecsleep(param);cout << "a"<< flush; mcsecsleep(param);cout << yellow+ "s"<< flush; mcsecsleep(param);cout << "e"<< flush; mcsecsleep(param);cout << " "<< flush;
    cout << "w"<< flush; mcsecsleep(param);cout << green+ "a"<< flush; mcsecsleep(param);cout << "i"<< flush; mcsecsleep(param);cout << "t"<< flush; mcsecsleep(param);
    mcsecsleep(param2);cout << "."<< flush; mcsecsleep(param2);cout << "."<< flush; mcsecsleep(param2);cout << "." + reset << flush; mcsecsleep(param2);
    cout << "\n";
    return 1;
}
...
int menuHandler::about(){
	...
	cout << yellow+"▒▒░░░░░░░░░░░░░░                      ░░██                                                             ▒▒" << endl;
	cout << yellow+"▒▒░░░░░░░░░░░░░░                      ██                                                               ▒▒" << endl;
	cout << yellow+"▒▒▒▒░░░░░░░░░░░░░░                  ░░██            "+red+"This program was made by 2 members:"+yellow+"                ▒▒" << endl;
	cout << yellow+"▒▒▒▒▒▒░░░░░░░░░░░░░░░░              ██                 "+red+"- Nguyen Huu Tung"+yellow+"                               ▒▒" << endl;
	cout << yellow+"▒▒▒▒▒▒▒▒░░░░░░░░░░░░░░░░            ██                 "+red+"- Huynh Van Thai"+yellow+"                                ▒▒" << endl;
	cout << yellow+"▒▒▒▒▒▒▒▒▒▒░░░░░░░░░░░░░░░░░░    ░░░░██    "+red+"Please read the "+magenta+"README.md"+red+" first before using the program"+yellow+"     ▒▒" << endl;
	cout << yellow+"▒▒         ▒░░░░░░░░░░░░░░░░░░░░░░██                                                                   ▒▒" << endl;
	cout << yellow+"▒▒         ▒▒▒▒▒░░░░░░░░░░░░░░░░░░██                                                                   ▒▒" << endl;
	cout << yellow+"▒▒         ▒▒▒▒▒▒▒░░░░░░░░░░░░░░░░██                                                                   ▒▒" << endl;
	cout << yellow+"▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒░░░░░░░░░░░░██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒" << endl;
	...
	cout << reset + "\n";
    cout << inverse + "Press enter to go back: " + reset;
